...
class M_sppd extends CI_Model {
    ...
    public function daftar(){
        ...
        $this->db->join('tb_pegawai', 'tb_sppd.id_pegawai = tb_pegawai.id_pegawai');
        $query = $this->db->get();
        return $query->result();
    }
    ...
    public function edit($table,$data,$id){
        return $this->db->update($table,$data,array('id_sppd' => $id));
    }

    public function hapus($table, $id)
    {
        return $this->db->delete($table,array('id_sppd' => $id));
    }
    // -------------------------------------------------------------
