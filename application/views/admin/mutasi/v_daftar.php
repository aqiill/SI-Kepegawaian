			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<a href="<?php echo base_url('mutasi/tambah') ?>" class="btn btn-outline-success">Tambah</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-striped display" id="table-1">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo strtoupper($value->asal_instansi); ?></td>
										<td><?php echo strtoupper($value->nama_unitkerja); ?></td>
										<td><?php echo ucfirst($value->tmt_mutasi); ?></td>
										<td>
											<?php 
											  $id = (($value->id_mutasi*8*42/2)/2);
											  $link = base64_encode($id);
											  $link = str_replace('=', '', $link);
											 ?>											
											<a href="<?php echo base_url('mutasi/edit/').$link ?>" class="btn btn-outline-warning"><i class="fas fa-edit"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                    <a href="<?php echo base_url('mutasi/hapus_proses/').$link ?>" class="btn btn-danger">
                        <i class="fa fa-trash"></i> Hapus</a>

                    <a href="<?php echo base_url('mutasi/edit/').$link ?>" class="btn btn-warning">
