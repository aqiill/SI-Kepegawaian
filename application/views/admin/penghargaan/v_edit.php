<?php 
  $id = (($data['id_penghargaan']*8*42/2)/2);
  $link = base64_encode($id);
  $link = str_replace('=', '', $link);
 ?>
<form method="POST" action="<?php echo base_url('penghargaan/edit_proses/'.$link) ?>">
							...
							<div class="col-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="tingkat"
										placeholder="Tingkat" value="<?php echo $data['tingkat'] ?>"
										required>
								</div>
							</div>
							...
							<div class="col-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="ranking"
										placeholder="Ranking" value="<?php echo $data['ranking'] ?>"
										required>
								</div>
							</div>
							...
							<div class="col-4">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="tgl_penghargaan"
										placeholder="Tanggal" value="<?php echo $data['tgl_penghargaan'] ?>"
										required>
								</div>
							</div>
