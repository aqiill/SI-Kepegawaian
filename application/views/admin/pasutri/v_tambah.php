...
//Open form
echo form_open(base_url('pasutri/tambah'));
?>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="nama_pasutri"
										placeholder="Nama Pasangan" value="<?php echo set_value('nama_pasutri') ?>"
										required>
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="tgl_nikah"
										...
										value="<?php echo set_value('tgl_nikah') ?>" required>
								</div>
							</div>
							...
							<div class="col-12">
								<div class="form-group">
									...
									<input type="number" class="form-control" name="no_kartu" placeholder="No Kartu"
										value="<?php echo set_value('no_kartu') ?>" required>
								</div>
							</div>
						</div>
					</div>
