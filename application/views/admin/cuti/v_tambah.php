...
<form method="POST" action="<?php echo base_url('cuti/tambah') ?>">
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="t_mulai_cuti"
										placeholder="Tanggal Mulai Cuti" value="<?php echo set_value('t_mulai_cuti') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="t_selesai_cuti"
										placeholder="Tanggal Mulai Cuti" value="<?php echo set_value('t_selesai_cuti') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_surat_izin_cuti"
										placeholder="No Surat Izin" value="<?php echo set_value('no_surat_izin_cuti') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="pengesah_surat_cuti"
										placeholder="Pengesah Surat" value="<?php echo set_value('pengesah_surat_cuti') ?>"
										required>
								</div>
							</div>
