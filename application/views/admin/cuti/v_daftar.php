			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<a href="<?php echo base_url('cuti/tambah') ?>" class="btn btn-outline-success">Tambah</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-striped display" id="table-1">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php 
											  $id = (($value->id_cuti*8*42/2)/2);
											  $link = base64_encode($id);
											  $link = str_replace('=', '', $link);
											 ?>											
											<a href="<?php echo base_url('cuti/edit/').$link ?>" class="btn btn-outline-warning"><i class="fas fa-edit"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                    <a href="<?php echo base_url('cuti/hapus_proses/').$link ?>" class="btn btn-danger">
                        <i class="fa fa-trash"></i> Hapus</a>

                    <a href="<?php echo base_url('cuti/edit/').$link ?>" class="btn btn-warning">
