...
<form method="POST" action="<?php echo base_url('tunjangan/tambah') ?>">
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_tunjangan"
										placeholder="No Tunjangan" value="<?php echo set_value('no_tunjangan') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="tgl_tunjangan"
										placeholder="Tanggal Tunjangan" value="<?php echo set_value('tgl_tunjangan') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="jenis_tunjangan"
										placeholder="Jenis Tunjangan" value="<?php echo set_value('jenis_tunjangan') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="tmt_tunjangan"
										placeholder="TMT Tunjangan" value="<?php echo set_value('tmt_tunjangan') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="perkawinan_dari"
										placeholder="Perkawinan dari" value="<?php echo set_value('perkawinan_dari') ?>"
										required>
								</div>
							</div>
