<?php 
  $id = (($data['id_sertifikasi']*8*42/2)/2);
  $link = base64_encode($id);
  $link = str_replace('=', '', $link);
 ?>
<form method="POST" action="<?php echo base_url('sertifikasi/edit_proses/'.$link) ?>">
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_sertifikat_sertifikasi"
										placeholder="No Sertifikat Sertifikasi" value="<?php echo $data['no_sertifikat_sertifikasi'] ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_peserta"
										placeholder="No Peserta" value="<?php echo $data['no_peserta'] ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="mapel_sertifikasi"
										placeholder="Mata Pelajaran" value="<?php echo $data['mapel_sertifikasi'] ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="number" class="form-control" name="tahun_sertifikasi"
										placeholder="Tahun" value="<?php echo $data['tahun_sertifikasi'] ?>"
										required>
								</div>
							</div>
