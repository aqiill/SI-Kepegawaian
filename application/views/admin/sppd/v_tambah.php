...
<form method="POST" action="<?php echo base_url('sppd/tambah') ?>">
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_sppd"
										placeholder="No SPPD" value="<?php echo set_value('no_sppd') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="dari"
										placeholder="Dari" value="<?php echo set_value('dari') ?>"
										required>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="tujuan"
										placeholder="Tujuan" value="<?php echo set_value('tujuan') ?>"
										required>
								</div>
							</div>
								...
								<div class="form-group">
									<label>Uang Jalan</label>
								      <div class="input-group mb-2">
								        ...
								        <input name="uang_jalan" type="number" class="form-control" id="inlineFormInputGroup" placeholder="Uang Jalan">
								      </div>									
								</div>
							</div>
